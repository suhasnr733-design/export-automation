...
# Commercial-intent modifiers tuned for international export discovery
DEFAULT_INTENT_MODIFIERS = [
    # Top Wholesale & Importer Signals
    "wholesale distributor",
    "importer USA",
    "wholesaler UK Europe",
    "distributor Canada Australia",
    ...
    '"bulk order"',
    '"dealer inquiry"',
    # Niche & Specialty Extensions
    "sound healing wholesale distributor",
    "meditation yoga store supplier",
    "crystal bowl distributor B2B",
    "tibetan bowl wholesale importer",
    "handmade artisan goods importer",
    "holistic health wholesale",
    "procurement manager",
    "commercial buyer",
]
